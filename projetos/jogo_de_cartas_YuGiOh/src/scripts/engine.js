...
async function getRandomCardId() {
    const randoIndex = Math.floor(Math.random() * cardData.length);
    return cardData[randoIndex].id;
};
...
async function drawCards(cardNumbes, fieldSide) {
    for(let i = 0; i < cardNumbes; i++) {
